...
import { Alert, AlertDescription, Table, TableHeader, TableRow, TableHead, TableBody, TableCell } from '@workspace/ui';
...
export default function OrdersPage() {
  ...
  const {
    ...
    queryFn: async ({ pageParam }) => {
      ...
      return response.json() as Promise<{ items: OrderRow[]; nextCursor: string | null }>;
    },
